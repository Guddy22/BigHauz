...
function Footer() {
  return (
    ...
    <div>
    <footer className ="p-4 bg-white sm:p-6 dark:bg-gray-700">
    <div className ="md:flex md:justify-between max-w-full">
        ...
        <div>
                <h2 className ="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Universal Address</h2>
                <ul className ="text-gray-600 dark:text-gray-400">
                    <p className='text-2xl hover:text-white'> <a href= "https://ghanapostgps.com/map#CC0969033">GH-CC-096-8836</a></p>
                    <p>Post Code: CC096</p>
                    <p> Area: Pedu</p>
                    <p>Cape Coast</p>
                    <p></p>
            ...
            <div>
                ...
                <ul className ="text-gray-600 dark:text-gray-400">
                    <li>
                        <a  className ="hover:underline">Bighaus Family Limited </a>
                    </li>
                    <br/>
                    <p>Morocco Link</p>
                    <p> P.O.Box 886</p>
    ...
    <div className="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm text-gray-300 sm:text-center">© 2022 <a href="https://flowbite.com">BigHauz®</a>. All Rights Reserved.
        </span>
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="https://web.facebook.com/?_rdc=1&_rdr" className="text-gray-400 hover:text-white">
